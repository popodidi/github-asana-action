...
var ProjectTemplatesApi = exports.ProjectTemplatesApi = /*#__PURE__*/function () {
  ...
  */
   ...
   */
  _createClass(ProjectTemplatesApi, [{
    ...
    value: function deleteProjectTemplateWithHttpInfo(project_template_gid) {
      ...
      if (this.apiClient.RETURN_COLLECTION && false) {
        return Collection.fromApiClient(this.apiClient.callApi('/project_templates/{project_template_gid}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType), this.apiClient, {
    ...
    value: function getProjectTemplateWithHttpInfo(project_template_gid, opts) {
      ...
      // Check if RETURN_COLLECTION is set and return a collection object if it is
      if (this.apiClient.RETURN_COLLECTION && false) {
        return Collection.fromApiClient(this.apiClient.callApi('/project_templates/{project_template_gid}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType), this.apiClient, {
          'path': '/project_templates/{project_template_gid}',
          'httpMethod': 'GET',
          'pathParams': pathParams,
          'queryParams': queryParams,
    ...
    value: function instantiateProjectWithHttpInfo(project_template_gid, opts) {
      ...
      // Check if RETURN_COLLECTION is set and return a collection object if it is
      if (this.apiClient.RETURN_COLLECTION && false) {
        return Collection.fromApiClient(this.apiClient.callApi('/project_templates/{project_template_gid}/instantiateProject', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType), this.apiClient, {
